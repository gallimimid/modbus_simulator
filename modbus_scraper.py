...
def get_options():
    ...
    parser.add_option("-i", "--device",
        help="The device to scrape",
        dest="device", default=0x01)

    parser.add_option("-r", "--range",
        help="The address range to scan",
        dest="range", default="0:1000")
...
if __name__ == "__main__":
    ...
    main(opt.output, opt.port, opt.host, opt.device, opt.range, opt.debug)